      ...
      <section className="detail-grid-section gray-bg">
        <div className="container">
          ...
          <div className="services-grid services-grid-4">
            <div className="service-card">
              <Link href="/sua-chap-dien" className="card-link-wrapper">
                <div className="service-img-wrapper">
            ...
            <div className="service-card">
              <Link href="/sua-cong-to-dien" className="card-link-wrapper">
                <div className="service-img-wrapper">
            ...
            <div className="service-card">
              <Link href="/lap-dong-ho-dien" className="card-link-wrapper">
                <div className="service-img-wrapper">
            ...
            <div className="service-card">
              <Link href="/sua-dien-24h" className="card-link-wrapper">
                <div className="service-img-wrapper">
        ...
        <div className="container">
          ...
          <div className="news-grid">
            <div className="news-card">
              <Link href="/tin-tuc/kinh-nghiem-lap-dat-sua-chua-dien-nuoc" className="card-link-wrapper">
            ...
            <div className="news-card">
              <Link href="/tin-tuc/cac-quy-tac-va-nguyen-tac-an-toan-khi-sua-chua-dien-dan-dung-tai-nha" className="card-link-wrapper">
            ...
            <div className="news-card">
              <Link href="/tin-tuc/nhung-luu-y-an-toan-khi-sua-chua-dien-tai-nha-ma-ban-nen-biet" className="card-link-wrapper">
            ...
            <div className="news-card">
              <Link href="/tin-tuc/nguyen-nhan-dan-den-ong-nuoc-hu-hong-va-cach-khac-phuc" className="card-link-wrapper">
